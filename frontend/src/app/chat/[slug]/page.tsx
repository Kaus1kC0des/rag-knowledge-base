    ...
    <div className="flex flex-col h-[calc(100vh-80px)] max-w-4xl mx-auto">
      ...
      <div className="border-b p-4 bg-white dark:bg-gray-800">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-semibold">Chat {params.slug}</h1>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-900">
        ...
        {isLoading && (
          <div className="flex items-start space-x-3">
            ...
            <div className="bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-4 py-2 rounded-lg shadow-sm">
      ...
      <div className="border-t p-4 bg-white dark:bg-gray-800">
        <div className="flex space-x-2">
          <textarea
            ...
            className="flex-1 resize-none border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white max-h-32"
            rows={1}
            disabled={isLoading}
          />
          <button
